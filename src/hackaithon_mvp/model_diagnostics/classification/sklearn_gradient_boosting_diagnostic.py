"""Metadata-only adapter for Sklearn Gradient Boosting."""
...
class SklearnGradientBoostingDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'sklearn_gradient_boosting'
    display_name = 'Sklearn Gradient Boosting'
