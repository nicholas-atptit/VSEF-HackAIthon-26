"""Metadata-only adapter for Logistic Elastic Net."""
...
class LogisticElasticNetDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'logistic_elastic_net'
    display_name = 'Logistic Elastic Net'
