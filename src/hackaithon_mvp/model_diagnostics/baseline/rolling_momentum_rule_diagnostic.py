"""Metadata-only adapter for Rolling Momentum Rule."""
...
class RollingMomentumRuleDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'rolling_momentum_rule'
    display_name = 'Rolling Momentum Rule'
