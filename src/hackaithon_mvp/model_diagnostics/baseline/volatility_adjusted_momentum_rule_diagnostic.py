"""Metadata-only adapter for Volatility Adjusted Momentum Rule."""
...
class VolatilityAdjustedMomentumRuleDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'volatility_adjusted_momentum_rule'
    display_name = 'Volatility Adjusted Momentum Rule'
