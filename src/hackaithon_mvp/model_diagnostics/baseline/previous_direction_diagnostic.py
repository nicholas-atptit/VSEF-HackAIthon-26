"""Metadata-only adapter for Previous Direction."""
...
class PreviousDirectionDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'previous_direction'
    display_name = 'Previous Direction'
