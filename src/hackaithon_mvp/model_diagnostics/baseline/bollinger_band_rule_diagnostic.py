"""Metadata-only adapter for Bollinger Band Rule."""
...
class BollingerBandRuleDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'bollinger_band_rule'
    display_name = 'Bollinger Band Rule'
