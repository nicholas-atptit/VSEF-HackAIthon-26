"""Metadata-only adapter for Moving Average Rule."""
...
class MovingAverageRuleDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'moving_average_rule'
    display_name = 'Moving Average Rule'
