"""Metadata-only adapter for Mean Reversion Rule."""
...
class MeanReversionRuleDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'mean_reversion_rule'
    display_name = 'Mean Reversion Rule'
