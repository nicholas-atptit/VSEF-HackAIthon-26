"""Metadata-only adapter for Volume Momentum Rule."""
...
class VolumeMomentumRuleDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'volume_momentum_rule'
    display_name = 'Volume Momentum Rule'
