"""Metadata-only adapter for High Low Volatility Router."""
...
class HighLowVolatilityRouterDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'high_low_volatility_router'
    display_name = 'High Low Volatility Router'
