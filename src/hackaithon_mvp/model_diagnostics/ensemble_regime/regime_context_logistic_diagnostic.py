"""Metadata-only adapter for Regime Context Logistic."""
...
class RegimeContextLogisticDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'regime_context_logistic'
    display_name = 'Regime Context Logistic'
