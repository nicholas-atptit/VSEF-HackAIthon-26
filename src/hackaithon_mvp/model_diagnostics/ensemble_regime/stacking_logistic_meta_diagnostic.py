"""Metadata-only adapter for Stacking Logistic Meta."""
...
class StackingLogisticMetaDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'stacking_logistic_meta'
    display_name = 'Stacking Logistic Meta'
