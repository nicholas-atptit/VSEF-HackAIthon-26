"""Metadata-only adapter for Regime Model Router."""
...
class RegimeModelRouterDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'regime_model_router'
    display_name = 'Regime Model Router'
