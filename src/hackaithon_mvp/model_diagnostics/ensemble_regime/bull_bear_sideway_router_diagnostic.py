"""Metadata-only adapter for Bull Bear Sideway Router."""
...
class BullBearSidewayRouterDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'bull_bear_sideway_router'
    display_name = 'Bull Bear Sideway Router'
