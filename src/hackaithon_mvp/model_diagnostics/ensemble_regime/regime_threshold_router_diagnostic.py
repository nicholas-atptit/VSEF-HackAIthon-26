"""Metadata-only adapter for Regime Threshold Router."""
...
class RegimeThresholdRouterDiagnosticAdapter(BaseDiagnosticAdapter):
    model_key = 'regime_threshold_router'
    display_name = 'Regime Threshold Router'
