...
def test_adapter_disabled_by_default(monkeypatch, tmp_path):
    ...
    result = run_optional_vn_market_data_expansion(output_root=str(tmp_path / ".tmp_data_expanded_60pct" / "data"))
...
def test_config_redacts_secret_like_values(monkeypatch):
    ...
    monkeypatch.setenv("OUTPUT_ROOT", ".tmp_data_expanded_60pct/data")
    monkeypatch.setenv("API_KEY", "secret")

    result = inspect_vn_market_data_config(output_root=".tmp_data_expanded_60pct/data")
